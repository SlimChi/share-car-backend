 ...
 */
final class Version20231116063249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etape (id INT AUTO_INCREMENT NOT NULL, trajet_id INT NOT NULL, adresse_depart VARCHAR(255) NOT NULL, code_postal_depart INT NOT NULL, ville_depart VARCHAR(255) NOT NULL, adresse_arrivee VARCHAR(255) NOT NULL, code_postal_arrivee INT NOT NULL, ville_arrivee VARCHAR(255) NOT NULL, INDEX IDX_285F75DDD12A823 (trajet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, url VARCHAR(255) NOT NULL, INDEX IDX_C53D045FFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image_voitures (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, image_url VARCHAR(255) NOT NULL, INDEX IDX_4A8BEB3FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trajet (id INT AUTO_INCREMENT NOT NULL, voiture_id INT NOT NULL, utilisateur_id INT NOT NULL, prix INT NOT NULL, fumeur TINYINT(1) NOT NULL, silence TINYINT(1) NOT NULL, musique TINYINT(1) NOT NULL, animaux TINYINT(1) NOT NULL, date_depart VARCHAR(255) NOT NULL, heure_depart VARCHAR(255) NOT NULL, INDEX IDX_2B5BA98C181A8BA (voiture_id), INDEX IDX_2B5BA98CFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, date_inscription DATETIME NOT NULL, pseudo VARCHAR(255) DEFAULT NULL, credit_jeton INT NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, date_de_naissance VARCHAR(255) DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, reset_password_token VARCHAR(255) DEFAULT NULL, enabled TINYINT(1) NOT NULL, biographie LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE image_voitures ADD CONSTRAINT FK_4A8BEB3FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_voitures DROP FOREIGN KEY FK_4A8BEB3FB88E14F');
        ...
        $this->addSql('DROP TABLE image_voitures');
